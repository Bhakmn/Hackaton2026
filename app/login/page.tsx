  ...
  return (
    <PageTransitionWrapper maxWidth="narrow">
      <div className={styles.card}>
        <p className={styles.eyebrow}>Welcome to Ditto</p>
        <h1 className={styles.heading}>Sign in to continue</h1>
        <p className={styles.sub}>Choose your preferred sign-in method.</p>
        ...
        <div className={styles.buttons}>
          ...
          >
            <svg viewBox="0 0 24 24">
              ...
              <path fill="#FBBC05" d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18A10.02 10.02 0 0 0 1.03 12c0 1.61.39 3.14 1.15 4.93l3.66-2.84z" />
          ...
          {/* Microsoft */}
          <a
            href="/auth/login?connection=windowslive"
